...
let petik = '```'
let enter = '\n'
let notnot = `NOTE:${enter}Jangan Lupa Subscribe Chennel Yt Aku Kak Link Yt https://youtu.be/knPyo5vnkvI`
...
let papako = [{
								...
								sendButLocation(from, teks , `Thank for verification 💋\n${botname}妥︎⃟🐣 | By ${ownername}`, thumbnail, papako, {contextInfo: { mentionedJid: [sender]}})
                }
